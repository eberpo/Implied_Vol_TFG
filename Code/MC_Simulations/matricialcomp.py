...
pdmethods = {'Method':["Matricial Raw Monte Carlo", "Matricial Conditional Monte Carlo"], 'Average Price':[np.mean(payoffraw), np.mean(payoffcond)], 'Prices Standard Deviation':[np.var(payoffraw), np.var(payoffcond)], 'Exectution Time':[rawtime, condtime]}
...
pdmethods.to_csv('prixSimsResults/matricialmethods.csv')
